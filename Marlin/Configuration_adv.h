 ...
 */
  ...
  #define CHAMBER_MAXTEMP            220 //Changed from 60
  ...
  #define BED_CHECK_INTERVAL 1000 // ms between checks in bang-bang control, from 5000 to 1000 Tsegai
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        20 // Seconds. Going from 20 to 40
  #define THERMAL_PROTECTION_BED_HYSTERESIS     2 // Degrees Celsius. Going from 2 to 10.

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD                60 // Seconds. From 60 to 80
  #define WATCH_BED_TEMP_INCREASE               2 // Degrees Celsius. From 2 to 10
#endif
 ...
 */
  ...
  #define THERMAL_PROTECTION_CHAMBER_PERIOD    20 // Seconds 20
  #define THERMAL_PROTECTION_CHAMBER_HYSTERESIS 1 // Degrees Celsius 1

  /**
   * Heated chamber watch settings (M141/M191).
   */
  #define WATCH_CHAMBER_TEMP_PERIOD            400 // Seconds
...
//
  ...
  // UTF8 processing and renderingZ.
