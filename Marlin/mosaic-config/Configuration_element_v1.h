...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_EL_DORADO
#endif
...
#define CUSTOM_MACHINE_NAME "AEL105 Main Board"
...
// For Beryllium 11 with new bed thermistor use 1000
...
#define TEMP_WINDOW 1          // (°C) Temperature proximity for the "temperature reached" timer
#define TEMP_HYSTERESIS 15      // (°C) Temperature proximity considered "close enough" to the target
                                //
#if TEMP_SENSOR_BED
  #define TEMP_BED_RESIDENCY_TIME     10  // (seconds) Time to wait for bed to "settle" in M190
  #define TEMP_BED_WINDOW              1  // (°C) Temperature proximity for the "temperature reached" timer
  #define TEMP_BED_HYSTERESIS         30  // (°C) Temperature proximity considered "close enough" to the target
#endif
...
#define FILAMENT_RUNOUT_SCRIPT "M602"
...
#define HOMING_FEEDRATE_MM_M { (70*60), (70*60), (480) }
